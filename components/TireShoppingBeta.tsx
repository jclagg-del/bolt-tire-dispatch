...
export default function TireShoppingBeta({ internal = false }: { internal?: boolean }) {
  ...
  return <main className={`tire-beta-page ${internal?"internal":"public"}`}>
    ...
    {error && <div className="tire-beta-error"><strong>{internal?"ATD sandbox error":"Tire search is temporarily unavailable"}</strong><span>{internal?error:"Please try again in a moment. If this continues, call or text Bolt Tire for help."}</span></div>}
