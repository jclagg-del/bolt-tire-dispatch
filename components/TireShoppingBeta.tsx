...
type Product = {
  ...
  loadRange: string; discontinued: boolean; runFlat:boolean; hasRebate:boolean; serviceCategory:"passenger"|"truck"; fitmentPosition:"front"|"rear"|"both"; atdProductNumber: string;
